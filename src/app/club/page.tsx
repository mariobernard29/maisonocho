...
export default function LeClub8Page() {
  ...
  const handleAuthSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(
        err.message || "Ocurrió un error inesperado. Intente nuevamente.",
      );
    } finally {
        ...
        {loading ? (
          ...
          <div className="max-w-md mx-auto bg-[#0A0F0A] border border-gold/20 rounded-lg p-8 sm:p-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="text-center space-y-3 mb-8">
              ...
              <h1 className="editorial-title text-3xl text-gold font-light tracking-wide">
                LE CLUB 8
              </h1>
            ...
            <form
              ...
              className="space-y-4 text-xs text-[#FAF8F5]"
            >
              {isRegister && (
                <>
                  <div>
                    <label className="text-[9px] font-semibold tracking-wider text-gold uppercase block mb-1">
                      Nombre Completo
                    </label>
                  ...
                  <div>
                    ...
                    <span className="text-[9px] text-crema/35 mt-1 block">
                      Debe coincidir con el teléfono usado al hacer tus pedidos.
                    </span>
                  </div>
                </>
              )}
          ...
          <div className="max-w-4xl mx-auto space-y-10 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-olive/15 pb-6">
              <div className="space-y-1">
                <span className="editorial-subtitle text-[9px] text-gold tracking-widest font-bold uppercase">
                  Portal de Fidelidad
                </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                <div className="relative w-full max-w-[340px] aspect-[1.586] rounded-2xl bg-gradient-to-br from-[#121A12] via-[#0A0F0A] to-[#1e2a1e] border border-gold/40 shadow-2xl p-6 flex flex-col justify-between text-[#FAF8F5] overflow-hidden select-none group">
                  ...
                  <div className="flex justify-between items-start z-10">
                    <div className="space-y-0.5">
                      <h4 className="editorial-title text-lg tracking-widest text-gold font-light">
                        M A I S O N VIII
                      </h4>
                      <p className="text-[7px] tracking-[0.25em] text-crema/40 uppercase -mt-1">
                        REPOSTERIA FINA
                      </p>
                    </div>
                  ...
                  <div className="my-auto pt-2 z-10">
                    <span className="text-[8px] text-crema/40 uppercase tracking-widest block mb-0.5">
                      Saldo Disponible
                    </span>
                    <span className="text-2xl sm:text-3xl font-bold text-gold tracking-tight font-mono">
                      ${(userProfile.loyalty_balance || 0).toFixed(2)}{" "}
                      <span className="text-xs font-sans font-light">MXN</span>
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-end border-t border-gold/10 pt-3 mt-1 z-10">
                    <div className="space-y-0.5">
                      <span className="text-[7px] text-crema/45 uppercase tracking-widest block">
                        Socio
                      </span>
                      <span className="text-xs font-medium tracking-wide text-crema block">
                        {userProfile.name}
                      </span>
                    </div>
              ...
              <div className="md:col-span-7 grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#121A12]/5 border border-olive/10 rounded-lg p-5 space-y-1 relative overflow-hidden">
                  ...
                  <span className="text-[10px] text-olive/50 font-semibold uppercase tracking-wider block">
                    Acumulado Histórico
                  </span>
                  <p className="text-2xl font-bold font-mono text-olive">
                    ${(userProfile.loyalty_accumulated || 0).toFixed(2)}
                  </p>
                  <span className="text-[9px] text-olive/40 block leading-tight">
                    Total acumulado desde tu registro.
                  </span>
                </div>
                ...
                <div className="bg-[#121A12]/5 border border-olive/10 rounded-lg p-5 space-y-1 relative overflow-hidden">
                  ...
                  <p className="text-2xl font-bold font-mono text-olive">
                    {userProfile.orders_count || 0}
                  </p>
                  <span className="text-[9px] text-olive/40 block leading-tight">
                    Pedidos vinculados en el programa.
                  </span>
                </div>
                ...
                <div className="bg-[#121A12]/5 border border-olive/10 rounded-lg p-5 space-y-1 relative overflow-hidden">
                  ...
                  <span className="text-[9px] text-olive/40 block leading-tight">
                    Total de compras netas históricas.
                  </span>
                </div>
                ...
                <div className="bg-gold/5 border border-gold/20 rounded-lg p-5 space-y-1.5 flex flex-col justify-between">
                  ...
                  <p className="text-sm text-olive leading-relaxed font-light">
                    Acumulas el <span className="font-bold text-gold">5%</span>{" "}
                    de cashback digital de cada compra para usarlo como
                    descuento en tu siguiente checkout.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              {userOrders.length === 0 ? (
                <div className="bg-white/40 border border-olive/5 rounded-lg p-10 text-center">
                  ...
                  <p className="text-xs text-olive/55 font-light">
                    No tienes pedidos registrados en el Club todavía.
                  </p>
                  <Link
                    href="/menu"
                    ...
                    <table className="w-full text-xs text-left border-collapse">
                      <thead>
                        <tr className="bg-olive/5 text-olive font-semibold border-b border-olive/10">
                          ...
                          <th className="p-4 uppercase tracking-wider text-right text-gold">
                            Abono (5%)
                          </th>
                          <th className="p-4 uppercase tracking-wider text-center">
                            Estado
                          </th>
                        </tr>
                      </thead>
                        ...
                        {userOrders.map((o) => (
                          ...
                          >
                            ...
                            <td className="p-4 text-right font-medium text-green-700">
                              {o.loyalty_discount && o.loyalty_discount > 0
                                ? `-$${o.loyalty_discount.toFixed(2)}`
                                : "$0.00"}
                            </td>
                            <td className="p-4 text-right font-bold text-gold">
                              +$
                              {(o.loyalty_earned || o.subtotal * 0.05).toFixed(
                                2,
                              )}
                            </td>
